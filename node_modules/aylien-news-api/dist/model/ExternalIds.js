...
var _DunsNumber = _interopRequireDefault(require("./DunsNumber"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('duns')) {
          obj['duns'] = _ApiClient["default"].convertToType(data['duns'], [_DunsNumber["default"]]);
