    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('industries')) {
          obj['industries'] = _ApiClient["default"].convertToType(data['industries'], [_Category["default"]]);
        ...
        if (data.hasOwnProperty('published_datetime')) {
          obj['published_datetime'] = _ApiClient["default"].convertToType(data['published_datetime'], 'Date');
